...
export function generateCandidates(
  ...
  const isDirectTrial =
    ...
    /(اکانت تست|کانفیگ تست|تست رایگان|تست میدی|تست بدی|تست بده|اول تست|تست کنم|امتحان کنم|دمو داری|تست نیم ساعته|تست یک روزه|تست ۲۴ ساعته|تست ۱۲ ساعته|تست خوب بدی|تست اولش میدی|تست داری|تست سرعت|تست یک ساعته|یه ساعت تست|اولش تست|یه تست بده|اول امتحان کنم)/i.test(
      normText
    );
