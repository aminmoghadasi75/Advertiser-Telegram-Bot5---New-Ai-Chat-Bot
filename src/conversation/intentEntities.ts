...
export const ENTITY_PATTERNS = {
  ...
  REJECTION: /(نمیخوام|لازم ندارم|نیاز ندارم|علاقه ندارم|علاقه ای.*ندارم|علاقه‌ای.*ندارم|نیازی.*ندارم|تبلیغاتیه|تبلیغه|بازاریاب|فروشنده‌ای|ولم کن|نه مرسی|نه ممنون|(?:\b|^|\s)نه بابا(?:\b|$|\s)|دستت درد نکنه نمیخوام|تبلیغ نکن|اسپم نکن|خریدار نیستم|پول ندارم بدم|بس کن|حوصله ندارم|ولش کن نمیخوام|فیلترشکن نمیخوام|اصلا نمیخوام|قصد خرید ندارم|تمایلی ندارم|تمایلی.*ندارم|کنسله|صرف نظر کردم|منصرف شدم|دیگه پیام نده|حوصله تو ندارم|نمیخوام داداش|هیچی نمیخوام|از جای دیگه خریدم|از جای دیگه گرفتم|خریدم از جای دیگه|از جای دیگه|جای دیگه خریدم|از جا دیگه)/i,

  OBJECTION: /(گرونه|خیلی گرونه|گرونه بابا|گرانه|تخفیف|ارزونتر|کلاهبردار|کلاهبرداری|اعتماد ندارم|تضمینیه|تضمینی هست|نکنه قطع بشه|نکنه فیلتر بشه|پولمون بسوزه|گارانتی بازگشت وجه|ضمانت مرجوعی|سایفون دارم|سایفون رایگان|رایگان دارم|خودم رایگان دارم|خودم vpn دارم|بلد نیستم.*(کانفیگ|نصب|برنامه)|پیچیده و سخته|پاسخگو نبودن|چرا اینقدر گرونه|چرا اینقدر قیمتش بالاست|بقیه کانالا.*میدن|از هرکی خریدم.*قطع|نصف این قیمت|سرور اختصاصی طلاست|مگه.*(طلاست|ناسا)|قبلا از یه کانال خریدم|پشتیبانی جواب نمیدن|بدون تست خرید نمیکنم|پول ندارم بدم|تضمین بدون قطعی|خودم اختصاصی دارم|خودم دارم|سابقه قطعی)/i,

  NEED: /(اینترنت.*(قطعه|خرابه|کنده|افتضاحه|داغونه|وصل نمیشه|نمیکشه|محدوده)|نت.*(قطعه|خرابه|کنده|افتضاحه|داغونه|وصل نمیشه|نمیکشه)|نت ملی|ملی شده|فیلترینگ|اینستا.*(باز نمیشه|وا نمیشه|قطعه|وصل نمیشه|لود نمیشه|فیلتره)|تلگرام.*(باز نمیشه|قطعه|وصل نمیشه|لود نمیشه|عکس.*لود نمیشه|وویس.*گوش)|یوتیوب.*(باز نمیشه|قطعه|وصل نمیشه|لود نمیشه|۴k|ویدیو.*آپلود)|پینترست|پینگ.*(بالاست|داغونه|رفته بالا|بالا|۳۰۰)|نت خوابگاه|سرعت داغونه|استوری آپلود نمیشه|فروش صفر شده|سفارش مشتری|پروژه‌هام.*تحویل|هیچ فیلترشکنی کار نمیکنه|فیلترشکنام.*از کار افتاده|کانفیگام.*از کار افتادن|کل فیلترشکنام|همه چی فیلتره|تحریم شکن|وضع نت|هیچی باز نمیشه|کلافه شدم|درمونده شدم|اعصابم خورده|اعصابم داغونه|روزی \d+ گیگ دانلود|کارم دانلوده|کارم فریلنسریه.*قطعی|عکس.*لود نمیشه|ترید.*صرافی|بایننس.*آیپی|حسابم بسته میشه|ترید میکنم|حیاتیه)/i,

  BOT_SUSPICION: /(?!.*(رباتیک|روباتیک))(تو رباتی|رباتی\?|رباتی؟|رباتی(?!\w)|ربات هستی|ربات نشسته|هوش مصنوعی|ai هستی|باتی(?!\w)|انسان نیستی|داری ضبط شده|داری خودکار|خودکار(?!\w)|از پیش ضبط شده|پیام.*خودکار|پشت گوشی کیه|پشت گوشی.*(ربات|انسان|کیه|ادم)|لحنت مثل بات|مثل رباتا|مثل باتا|مثل بات|مثل روبات|چرا مثل بات|چرا مثل ربات|ربات نیستی|یا ادمی|پشت خط ادمه|پشت خط کیه|چت باتی|چت جی پی تی|پیامای از قبل آماده|آماده شده.*بات|واقعی هستی|ربات چت)/i,
  ...
  QUESTION_MARKERS: /(\?|؟|چرا|چطور|چجوری|کجا|کی|آیا|مگه|کدوم|چی خوردی|اهل .* هستی|داری\?|داری؟|باشگاه میری|حیوون خونگی|پایتون کار میکنی|کد زدن|پیشنهاد بدی|دانشگاه رفتی|مشغولی|اهل کجایی|چی گوش میدی|چه پادکستی|چه فیلمی|کجا رفتی|آموزش|سوال داشتم|سوال دارم|فقط سوال)/i,
...
export function extractEntities(normText: string): ExtractedEntities {
  ...
  const hasWeatherOrHomeAppliance = /(کولر|بخاری|پکیج|خراب شد|هوا خیلی گرم|هوا گرم شده)/i.test(normText);
  const hasShippingOrHardware = /(کشتیرانی|کشتیرانی جمهوری اسلامی|خرید لپ‌تاپ|ایسوس|بازار رضا|لپ تاپ|لپ‌تاپ)/i.test(normText);
  ...
  const hasComparisonToken = /(چه پلن‌هایی|کدوم پلن|فرق پلن|لیست پلن|انواع پلن|کدوم بسته|پلن هاتون چیه|تنوع پلن|چه حجم هایی|حجم هایی)/i.test(normText);
  ...
  const hasPriceResistance = /(گرونه|خیلی گرونه|گرونه بابا|گرانه|تخفیف|ارزونتر|چرا اینقدر گرونه|چرا اینقدر قیمتش بالاست|قیمتتون هم بالاست|قیمتتون بالاست|قیمتش بالاست|مگه.*(طلاست|ناسا)|نصف این قیمت|قیمتش زیاده|گرون میدی|چه خبره)/i.test(normText);
  ...
  const hasFrustrationOrImpact = /(درمونده شدم|کلافه شدم|اعصابم خورده|اعصابم خورد|اعصابم داغونه|کار و زندگیم.*(خوابیده|لنگ)|فروش صفر شده|سفارش مشتری|پروژه‌هام.*تحویل|هیچی باز نمیشه|هیچ عکسی|وویس تلگرام|دانلود نمیتونم بکنم)/i.test(normText);
  ...
  const hasBotSuspicion = !/رباتیک|روباتیک/i.test(normText) && (ENTITY_PATTERNS.BOT_SUSPICION.test(normText) || /اماده شده.*(بات|ربات)|پیامای از قبل اماده|آماده شده.*(بات|ربات)|پیامای از قبل آماده/i.test(normText));
  ...
  const hasOccupationOrStudy =
    /(شغلت چیه|تو چیکاره‌ای|تو چیکاره ای|دانشجوام|دانشجو ام|دانشگاه|رشته [آ-ی]+ خوندم|رشته [آ-ی]+ میخونم|کارمند|معمار|آنلاین شاپ|برنامه نویس|پزشک|معلم|فریلنسر|شغل|شاغلم|سر کار|تایم بیکاریم|بیکارم|مدیرمون|رشته معماری|رشته کامپیوتر|رشته هنر|مهندسی صنایع|حسابداری|دانشجوی سال|کار آزاد|مهندس شبکه|سفالگری|فیزیوتراپ|نقشه‌برداری|آبدارچی|نگهبان)/i.test(normText);

  const hasRoutineOrDailyStatus =
    /(خسته شدم|خسته کننده|سر کار بودم|غر شنیدم|تازه بیدار شدم|شام پیتزا|ناهار خوردم|شام سفارش دادم|دارم چایی میخورم|دارم چای|صدای بارون|خوابم میاد|حوصلم سر رفته|حوصله ام سر رفته|دلم گرفته|روز شلوغی بود|روز زندگیم|زیر باد کولر|هوای بیرون|عکسهای قدیمی|یاد قدیما|هوا گرمه|هوا بارونیه|تنهایی نشستم|خوابیده بود|اومدم چت کنم|بحثو عوض کنیم|چت کنم|زندگی میکنم|هوا عالیه|هوا خوبه|دعوام شد|فحش ندادم)/i.test(normText);

  const hasHobbyOrActivity =
    /(گیم میزنم|بازی میکنم|بازیگوشی|فیلم میبینم|سریال میبینم|موزیک گوش میدم|آهنگ گوش میدم|شادمهر|هایده|خواننده|گوش میدم.*آرامش|پادکست|کتاب میخونم|بدنسازی|باشگاه|ورزش میکنم|گربه|سگ|حیوون خانگی|حیوون خونگی|قورمه سبزی|ژانر|اینتراستلار|آلمان اقدام میکنم|مدارکم رو ترجمه میکنم|زبان میخونم|گیتار میزنم|پیاده روی|کوه|اخبار دانشگاه|پرنده‌نگری|اوریگامی)/i.test(normText);
