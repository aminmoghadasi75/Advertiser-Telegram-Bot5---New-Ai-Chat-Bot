...
const PRESET_BOTS: Partial<AnonymousBotProfile>[] = [
  {
    ...
    notInChatKeywords: ['متوجه نشدم', 'دستور نامعتبر', 'از منوی زیر استفاده', 'برای شروع از دکمه', 'منوی اصلی', 'پیام شما متوجه نشدم'],
    alreadyInChatKeywords: ['هم اکنون شما در حال چت هستید', 'هم اکنون در حال چت هستید', 'خطا : هم اکنون شما در حال چت هستید', 'خطا: هم اکنون شما در حال چت هستید', 'ابتدا چت فعلی را قطع کنید', 'در حال حاضر در حال چت هستید'],
